...
- If anything is missing or if you find something that needs to be enhanced/fixed/modified in the project, please feel free to [create an issue.](https://github.com/singodiyashubham87/Mindfulness/issues/new/choose)
...
<img src="./client/src/assets/images/fork.jpg"/>

By forking the repository, you will have your repository version under your GitHub username.
...
```sh
git clone https://github.com/YOUR-USERNAME/Mindfulness.git
```
...
npm install
```
### Step 5: Edit the ".env" file with required configurations
```sh
...
**NOTE:** Proceed with steps 7-9 only if there is a need for backend interaction

### Step 7: Go to the server directory
```sh
cd Mindfulness/server
```
### Step 8: Create and source a virtual environment:
```sh
python -m venv venv
...
### Step 10: Create a New Branch (important)
...
Once you have added changes in your local, it's time to push them, for that run this command to bring the modification to the staging area.

### Step 12: Check your changes
...
<h3> Don't forget to give a ⭐ to this repo !!
<h1>
